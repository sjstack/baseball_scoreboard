...
def print_game( game, hit, error ):
    ...
    inning_str = str( game["inning"]["number"] ).rjust( 2, " " ).ljust( 3, " " )
    ...
    away_inning_runs_1 = str( game["away"]["box"][0] ).rjust( 2, " " ).ljust( 3, " " )
    away_inning_runs_2 = str( game["away"]["box"][1] ).rjust( 2, " " ).ljust( 3, " " )
    away_inning_runs_3 = str( game["away"]["box"][2] ).rjust( 2, " " ).ljust( 3, " " )
    away_inning_runs_4 = str( game["away"]["box"][3] ).rjust( 2, " " ).ljust( 3, " " )
    away_inning_runs_5 = str( game["away"]["box"][4] ).rjust( 2, " " ).ljust( 3, " " )
    away_inning_runs_6 = str( game["away"]["box"][5] ).rjust( 2, " " ).ljust( 3, " " )
    away_inning_runs_7 = str( game["away"]["box"][6] ).rjust( 2, " " ).ljust( 3, " " )
    away_inning_runs_8 = str( game["away"]["box"][7] ).rjust( 2, " " ).ljust( 3, " " )
    away_inning_runs_9 = str( game["away"]["box"][8] ).rjust( 2, " " ).ljust( 3, " " )

    home_inning_runs_1 = str( game["home"]["box"][0] ).rjust( 2, " " ).ljust( 3, " " )
    home_inning_runs_2 = str( game["home"]["box"][1] ).rjust( 2, " " ).ljust( 3, " " )
    home_inning_runs_3 = str( game["home"]["box"][2] ).rjust( 2, " " ).ljust( 3, " " )
    home_inning_runs_4 = str( game["home"]["box"][3] ).rjust( 2, " " ).ljust( 3, " " )
    home_inning_runs_5 = str( game["home"]["box"][4] ).rjust( 2, " " ).ljust( 3, " " )
    home_inning_runs_6 = str( game["home"]["box"][5] ).rjust( 2, " " ).ljust( 3, " " )
    home_inning_runs_7 = str( game["home"]["box"][6] ).rjust( 2, " " ).ljust( 3, " " )
    home_inning_runs_8 = str( game["home"]["box"][7] ).rjust( 2, " " ).ljust( 3, " " )
    home_inning_runs_9 = str( game["home"]["box"][8] ).rjust( 2, " " ).ljust( 3, " " )
...
if __name__ == "__main__":
    ...
    while True:
        ...
        mlb_game = find_game_by_team( resp_json, "Yankees" )
